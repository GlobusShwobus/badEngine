...
namespace badEngine
{
	//TODO come back to it in the future...
	//this type of shape incapable of scaling but it is lighter and far more performant to draw than individual points/lines
	//can be used in game logic for some effects where the circles stay the same size. like blowing bubbles or something...
	//in terms of physics it is capable of doing largely the same thing. only thing it can't do is scaling and changing colors (or it can with extra code)
